...
class Preprocessor:
    ...
    def build_from_path(self):
        ...
        print(
            "Train time: {} / {} hours".format(
                train_cnt, train_n_frames * self.hop_length / self.sampling_rate / 3600
            )
        )

        print(
            "Val time: {} / {} hours".format(
                val_cnt, val_n_frames * self.hop_length / self.sampling_rate / 3600
            )
        )
